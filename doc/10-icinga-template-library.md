...
The [check_openmanage](https://folk.uio.no/trondham/software/check_openmanage.html) plugin
...
The [check_jmx4perl](https://search.cpan.org/~roland/jmx4perl/scripts/check_jmx4perl) plugin
...
[documentation](https://search.cpan.org/~roland/jmx4perl/scripts/check_jmx4perl).
